 ...
 * @author mike
 */
public class JCalendarHeaderBeanInfo extends SimpleBeanInfo {
    private static final String FILE = "/mike/utils/jsimplecalendar/resources/JSimpleCalendar%s.gif";
    @Override
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(JCalendarHeader.class, null);
        bd.setDisplayName("Calendar");
        bd.setShortDescription("A simple calendar pane");
        return bd;
    }
    @Override
